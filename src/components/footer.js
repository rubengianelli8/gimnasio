...
const Footer = () => {
  return (
    <footer className="grid gap-y-[20px] md:gap-y-0 grid-cols-1 md:grid-cols-3 w-screen bg-black text-white px-[30px] py-[30px] place-content-center text-[14px] mt-auto">
