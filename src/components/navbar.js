...
const Navbar = () => {
  ...
  return (
    <nav className="h-[80px] w-screen px-[20px] bg-black text-white flex items-center">
      ...
      {showNavbar && (
        <ul className="bg-primary absolute top-0 right-0 flex flex-col md:hidden h-screen gap-y-4  w-[200px] justify-start text-[17px] font-medium pl-[10px] animation-mia">
